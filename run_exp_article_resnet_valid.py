...
for splt in ['fold1']:
    ...
    for code in code2id:
        ...
        for fold in range(1):
            ...
            dataset_cv = CustomDataset_ResNet(X_cv, y_cv_bin, transform=transform_resnet)
            ...
            for random_seed in range(n_splits):
                ...
                dataset_train = CustomDataset_ResNet(X_train, y_train_bin, transform=transform_resnet)
                dataset_val = CustomDataset_ResNet(X_val, y_val_bin, transform=transform_resnet)
                ...
                # init
                model = ResNet4Nose(num_classes=2).to(device)
                ...
                num_epochs = 40
                best_val_auc = 0.0
                best_path = "ResNet4Nose_best.pth"
...
rocs_df.to_csv('exp_binary_article_resnet_valid_split_weeks.csv', index=False)
